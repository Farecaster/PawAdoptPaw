                ...
                <div class="row g-2 align-items-start">
                    ...
                    <div class="col-6">
                        <div class="p-3">
                            ...
                            <br>
                            <p class="card-subtitle mb-2" style="color: #fffffe;"><strong>Breed: </strong>{{ $pet->breed }}</p>
                            <p class="card-subtitle mb-2" style="color: #fffffe;"><strong>Age: </strong>{{ $pet->age }} years old</p>
                            <p class="card-subtitle mb-2" style="color: #fffffe;"><strong>Gender: </strong>{{ $pet->gender }}</p>
                            <p class="card-subtitle mb-2" style="color: #fffffe;"><strong>Species: </strong>{{ $pet->species }}</p>
                            <p class="card-subtitle mb-2" style="color: #fffffe;"><strong>Region: </strong>{{ $pet->region }}</p>
                                ...
                                @auth                        
                                    @if (Auth::id() !== $pet->user->id)
                                        <div class="d-flex justify-content-start gap-2">
                                            <a href="{{ route('pet.adopt.create', ['pet' => $pet]) }}"
                                                class="btn"class="btn" style="background-color: #bae8e8; color: #272343;">Adopt Me
                                            </a>
                                            <button class="btn btn-danger" data-bs-toggle="modal"
                                            data-bs-target="#reportModal">Report</button>
                                            <a href="{{ route('user.profile', ['id' => $pet->user->id]) }}"
