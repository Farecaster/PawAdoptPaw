...
@section('content')
    <div class="pfabg">
        <img src="assets/8623528.png" class="img-fluid" alt="pfabg Image">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <form action="{{ route('post-for-adoption.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="gender" name="gender" required>
                                ...
                                <option value="Female" {{ old('species') == 'Female' ? 'selected' : '' }}>Female
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="region" name="region" required>
                                ...
                                <option value="Agusan del Sur" {{ old('region') == 'Agusan del Sur' ? 'selected' : '' }}>
                                ...
                                <option value="Camarines Norte" {{ old('region') == 'Camarines Norte' ? 'selected' : '' }}>
                                ...
                                <option value="Davao del Norte" {{ old('region') == 'Davao del Norte' ? 'selected' : '' }}>
                                ...
                                <option value="Davao Oriental" {{ old('region') == 'Davao Oriental' ? 'selected' : '' }}>
                                    Davao Oriental</option>
                                <option value="Dinagat Islands" {{ old('region') == 'Dinagat Islands' ? 'selected' : '' }}>
                                ...
                                <option value="Lanao del Norte" {{ old('region') == 'Lanao del Norte' ? 'selected' : '' }}>
                                ...
                                <option value="Northern Samar" {{ old('region') == 'Northern Samar' ? 'selected' : '' }}>
                                ...
                                <option value="South Cotabato" {{ old('region') == 'South Cotabato' ? 'selected' : '' }}>
                                    South Cotabato</option>
                                <option value="Southern Leyte" {{ old('region') == 'Southern Leyte' ? 'selected' : '' }}>
                                    Southern Leyte</option>
                                <option value="Sultan Kudarat" {{ old('region') == 'Sultan Kudarat' ? 'selected' : '' }}>
