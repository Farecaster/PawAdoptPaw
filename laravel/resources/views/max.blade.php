            ...
            <div class="col-md-10 mt-5 pt-5">
                <div class="row z-depth-3">
                    <div class="card mb-3">
                        ...
                        <h4 class="card-subtitle text-body-secondary">Labrador Retriever</h4><br>
                        <p class="card-text">Max is an energetic and friendly Labrador. 
                            He loves outdoor activities and playing fetch. Max is good 
                            with children and other dogs, and he's always eager to please.
                            He's house-trained and knows basic commands like sit and stay.</p>
                            <button class="btn bg-success text-dark" data-bs-toggle="modal" data-bs-target="#adoptModal">Adopt Me</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-body">
          ...
          <form>
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control" id="adopterAddress" placeholder="Enter your address" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control" id="adopterEmail" placeholder="Enter your email" required>
            </div>
            <div class="mb-3">
              <label for="adopterEmail" class="form-label">Date of Birth</label>
              <input type="month" class="form-control" id="adopterBirtdate" placeholder="Birthdate" required>
            </div>
            <div class="mb-3">
              <label for="adopterEmail" class="form-label">Veterinary Information:<br>Are you committed to providing regular veterinary care for your pet, 
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" id="additionalComments" rows="4" placeholder="Any additional comments or questions"></textarea>
            </div>
          </form>
        </div>
